...
const AppLayout = ({ children }) => {
  ...
  return (
      <div className="flex flex-col min-h-screen bg-gray-100">
        <header className="h-16 bg-green-600 flex items-center justify-between px-4 rounded-b-lg shadow-md">
          <div className="flex items-center">
            ...
            <h1 className="text-white text-xl font-bold">Green World</h1>
          </div>
        ...
        {flash?.error && (
          <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 m-5">
            {flash.error}
          </div>
        )}
